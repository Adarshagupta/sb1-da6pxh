    ...
    <>
      ...
      <div className="min-h-screen bg-white md:bg-gradient-to-br md:from-indigo-50 md:via-purple-50 md:to-pink-50 p-2 md:p-6">
        <div className="max-w-6xl mx-auto space-y-4 md:space-y-6">
          {/* Main Content Card */}
          <div className="bg-white md:bg-white/80 md:backdrop-blur-sm pb-12 rounded-2xl md:shadow-xl p-4 md:p-8 md:border md:border-white/20">
            {/* Header Section */}
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-6 md:mb-8">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h1 className="text-xl md:text-2xl font-bold text-gray-800">Create Professional Books</h1>
